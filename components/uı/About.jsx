    ...
    <div className='bg-secondary py-14'>
        <div className="container mx-auto flex items-center text-white gap-20 justify-center flex-wrap-reverse">
            ...
            <div className='text-white md:w-1/2'>
                <h1 className='font-dancing font-bold text-[2.3rem]'>We Are Feane</h1>
                <p className='my-5 flex flex-col items-center'>There are many variations of passages of Lorem Ipsum available, 
